...
|                    |                                                                                                                                                                                                                                         |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Jouer**          | 20 niveaux d'ordinateur (100 → 3200 Elo) avec 7 personnalités distinctes · parties entre amis en temps réel via un simple lien · partie locale à deux sur un écran                                                                      |
...
| **Apprendre**      | 60 leçons guidées en 9 chapitres, de « voici un échiquier » aux pièges d'ouverture tendus et déjoués, avec un coach qui parle et un échiquier interactif                                                                                |
...
| **Écouter**        | les 483 étapes du programme lues à voix haute et enchaînées tout seul, l'échiquier qui suit : pour réviser sans les mains                                                                                                               |
...
traduit, le **contenu** se rédige. Les 60 leçons, les explications de coups, les
...
finit par valider les 483 étapes de leçons. Chaque étape est facultative :
...
| `npm run check:lessons`                  | **valide les 483 étapes de leçons** : positions légales, coups jouables |
