...
export const fr = {
  ...
  computer: {
    ...
    // {adversaire} reçoit le nom en gras : voir `avecElements`.
    ...
    reviewingGame: 'Tu revois la partie. Rien n’est effacé.',
    ...
    leaveHint: 'Tu reviens aux réglages pour en lancer une autre.',
    leaveAction: 'Quitter la partie',
  ...
  live: {
    errors: {
      tooFast: 'Trop d’envois d’un coup. Attends un instant.',
      missingSlug: 'Identifiant de partie manquant.',
      linkUsed: 'Ce lien a déjà servi à une partie terminée. Crée une nouvelle partie.',
      serverFull:
      ...
      notAPlayer: 'Tu n’es pas joueur dans cette partie.',
      notPlaying: 'La partie n’est pas en cours.',
      notYourTurn: 'Ce n’est pas ton tour.',
      flagged: 'Le temps est écoulé.',
      illegal: 'Coup illégal.',
      unknown: 'Le serveur a refusé la demande.',
    },
  ...
  chemin: {
    ...
    nextRankAt: '{rang} à {seuil}',
    topRank: 'le plus haut rang',
    rankAria: 'Rang de carrière : {rang}, {xp} points. Voir la carrière',
    tierOf: 'Ton palier · {n} sur {total}',
    tierUnknown: 'Ton palier',
    tierBounds: '{min} – {max}',
    tierBoundsTop: '{min} et plus',
    estimatedAt: 'estimé à {elo}',
    tierAria: 'Palier {n} sur {total}, à {pct} % du palier suivant',
    whatCostsPoints: 'Ce qui te coûte des points',
    noLevelTitle: 'Où en es-tu ?',
    noLevelText:
      '{n} positions suffisent pour te placer sur l’un des {total} paliers, et savoir quoi travailler.',
    takeTest: 'Passer le test de niveau',
    nextStep: 'Prochaine étape · chapitre {n} sur {total}',
    chaptersAria: 'Chapitre {n} sur {total}',
    stepDone: 'c’est fait',
    duelAgainst: 'Duel contre {adversaire}',
    aboutElo: '≈ {elo}',
    continue: 'Continuer',
    careerDone: 'Carrière terminée',
    careerBlurb: '{n} chapitres, du premier coup à la première victoire nette.',
    daily: 'Défi du jour',
    dailyTodo: 'À faire',
    dailyDone: 'Relevé',
    dailyTodoHint: 'Une position · jouer',
    dailyDoneHint: '{xp} / {total} points du jour',
    streak: 'Série',
    days: '{n} jours',
    daysOne: '{n} jour',
    alsoForYou: 'Aussi pour toi',
    reviewLastGame: 'Revoir ta dernière partie',
    reviewLastGameAgainst: 'Revoir ta partie contre {adversaire}',
  },
  ...
  arena: {
    ...
    eloGamesPlayed: '{elo} Elo · {n} parties',
    eloOneGamePlayed: '{elo} Elo · {n} partie',
  ...
  api: {
    ...
    gameCorrupt: 'Cette partie ne se relit plus : ses coups enregistrés sont illisibles.',
    gameChanged: 'La partie a changé entre-temps. Recharge-la avant de rejouer.',
    friendUnknownUser: 'Personne de ce pseudo sur la plateforme.',
    friendSelf: 'Difficile de devenir son propre ami.',
    friendAlready: 'Vous êtes déjà en relation.',
    analysisRefused: 'Le serveur d’analyse a refusé la requête.',
    analysisTimeout: 'L’analyse a dépassé le temps imparti.',
    analysisUnreachable:
      'Le serveur d’analyse est injoignable. L’analyse se poursuivra dans ton navigateur, avec une profondeur plus modeste.',
    verifyLinkExpired: 'Ce lien a expiré. Demande-en un nouveau depuis ton profil.',
    verifyLinkUnknown: 'Ce lien ne correspond à rien. Il a peut-être déjà servi.',
    unknownCategory: 'Catégorie inconnue. Valeurs acceptées : {valeurs}.',
    providerRefused: 'Le fournisseur a refusé la requête.',
